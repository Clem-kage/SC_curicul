<template>
   <div class="module satelite" id="techno" @mouseover="addHoverEffect()" @mouseout="removeHoverEffect()">
    <h2>Technologies</h2>
    <svg width="800px" height="800px" viewBox="0 -3 19 19" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="auto" fill-rule="evenodd">
        <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -3283.000000)" fill="auto">
...
<script>
// import showComp from "./display/show-comp"
export default {
  components:{
   // showComp
  },
  ...
  methods:{
   addHoverEffect(){
      ...
      cvAp.classList.add('hover-effect-teck');
   },
   removeHoverEffect(){
      let cvAp = document.querySelector('html')
      cvAp.classList.remove('hover-effect-teck');
    }
  }
}
</script>
...
<style>
 ...
 .hover-effect-teck {
   ...
   background: linear-gradient(280deg, rgba(34,193,195,1) 0%, rgba(16,188,76,1) 100%); 
}
